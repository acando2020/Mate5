...
function actividad30() {
    ...
    Array.from(document.querySelectorAll('#resta2_2 td input ')).forEach(elemento => { arr4.push(elemento.value) });
    var num4 = parseInt(arr4.join(''));

    Array.from(document.querySelectorAll('#respuesta2 td div span')).forEach(elemento => { arrtotal2.push(elemento.textContent) });
    var resta2 = parseInt(arrtotal2.join(''));

    var restaTotal2 = parseInt(num3) - parseInt(resta2);
    ...
    var arr5 = [],
        arr6 = [],
        arrtotal3 = [];
    Array.from(document.querySelectorAll('#resta3_1 td input')).forEach(elemento => { arr5.push(elemento.value) });
    ...
    Array.from(document.querySelectorAll('#respuesta3 td div span')).forEach(elemento => { arrtotal3.push(elemento.textContent) });
    var resta3 = parseInt(arrtotal3.join(''));

    var restaTotal3 = parseInt(resta3) + parseInt(num6);
    if (num5 == restaTotal3) {
        Rresta3 = 2.5;
